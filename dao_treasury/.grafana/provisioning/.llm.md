...
## Persistent Rule: Meticulous Dashboard Review

- When making or reviewing any dashboard change, you **must**:
  - Carefully check every aspect of the dashboard, including SQL queries, panel configuration, overrides, transformations, legend, tooltip, and visual output.
  - Explicitly verify that all intended data series, overlays, and breakdowns are present and rendered as expected.
  - Confirm that no required field, grouping, or visual element is missing or broken after any change.
  - Never assume a change is correct without a full, detailed review of both the data and the rendered visual.

**Rationale:**  
This ensures that dashboards are always thoroughly checked for correctness, completeness, and visual clarity, preventing oversights and broken visuals.

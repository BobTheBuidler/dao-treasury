...
To view the dashboards, open your browser and navigate to [http://localhost:3004](http://localhost:3004) and log in with your Grafana admin credentials.
...
- **grafana**
  ...
  - Requires admin credentials via `GF_SECURITY_ADMIN_USER` and `GF_SECURITY_ADMIN_PASSWORD`.

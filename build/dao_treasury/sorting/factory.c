...
PyInit_factory(void)
{
    ...
    PyObject *capsule = PyObject_GetAttrString(tmp, "init_dao_treasury___sorting___factory");
    Py_DECREF(tmp);
    if (capsule == NULL) return NULL;
    void *init_func = PyCapsule_GetPointer(capsule, "dao_treasury__mypyc.init_dao_treasury___sorting___factory");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
...
PyMODINIT_FUNC PyInit___init__(void) { return PyInit_factory(); }
